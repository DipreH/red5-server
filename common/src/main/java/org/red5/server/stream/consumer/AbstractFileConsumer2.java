...
public class AbstractFileConsumer2 implements IPipeConnectionListener {
    protected static final Logger log = LoggerFactory.getLogger(SlicedFileConsumer.class);
    /**
     * Scope
     */
     ...
     */
    protected int queueThreshold = -1;
    /**
